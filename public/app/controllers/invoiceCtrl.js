angular.module('invoiceController', ['customerController', 'officeController', 'glaccountController', 'itemController','configServices', 'journalentryServices'])

.controller('invoiceCtrl', function(Customer, Office, GLAccount, Item, Invoice, InvoiceLine, $timeout, $location, 
    ...
    if($routeParams.id == null) {
        ...
        app.total = function(){
            ...
            $scope.invoiceData.invoicetotal = total;
            return total;
        };
        ...
        app.createGLPosting = function(invoiceData, invoicelines) {
            ...
            JournalEntryData.office = invoiceData.office;
        ...
        if (data.data.success) {
            ...
            // $scope.invoiceData = data.data.invoice; // Display office name in scope
            $scope.invoiceData.office = data.data.invoice.office;
            ...
            $scope.invoiceData.invoicetotal = data.data.invoice.invoicetotal;
            ...
            InvoiceLine.getInvoiceLines($routeParams.id).then(function(lines) {
                if (lines.data.success) {
                    ...
                    // console.log($scope.invoiceData);
                    $scope.lines = lines.data.invoicelines; // Display office name in scope
...
.controller('invoicereportCtrl', function(Customer, Office, GLAccount, Item, Invoice, InvoiceLine, $timeout, $location,$scope, Config) {
...
.controller('viewinvoiceCtrl', function($scope, $routeParams, User, Office, $timeout, $location) {
})